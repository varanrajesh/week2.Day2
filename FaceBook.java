...
public class FaceBook
{
    ...
    public static void main (String[] args)
    {
        ...
        driver.findElement ( By.xpath ( "//input[@name='firstname']" ) ).sendKeys ( "Rajeshwaran" );
        ...
        driver.findElement ( By.xpath ( "//input[@name='reg_email__']" ) ).sendKeys ( "9003458596" );

        // Step 10: Enter the password
        driver.findElement ( By.xpath ( "//input[@name='reg_passwd__']" ) ).sendKeys ( "9003458596" );
